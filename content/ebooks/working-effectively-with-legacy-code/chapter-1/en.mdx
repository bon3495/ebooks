...
<IllustrationImage src="/assets/images/ebooks/working-effectively-with-legacy-code/preserving-behavior.png" alt="Preserving Behavior" label="Figure 1.1">Preserving behavior.</IllustrationImage>
