...
<IllustrationImage src="/assets/images/ebooks/working-effectively-with-legacy-code/preserving-behavior.png" alt="Preserving Behavior" label="Figure 1.1" sizeDialog="md">Preserving behavior.</IllustrationImage>
