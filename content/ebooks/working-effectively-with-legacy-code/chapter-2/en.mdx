...
<IllustrationImage src="/assets/images/ebooks/working-effectively-with-legacy-code/figure-2-1.png" alt="Invoice update classes." label="Figure 2.1" size="lg">Invoice update classes.</IllustrationImage>
...
<IllustrationImage src="/assets/images/ebooks/working-effectively-with-legacy-code/figure-2-2.png" alt="Invoice update classes." label="Figure 2.2" size="lg">Invoice update classes with dependencies broken.</IllustrationImage>
